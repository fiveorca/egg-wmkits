...
const INT_32_MIN_VALUE = -2147483648;
...
function checkInt(rule, value) {
  ...
  if(isOutOfInt32(value)){
    return this.t('should be not out of range for an int32');
  }
}

function checkStrInt(rule, value) {
...
function isOutOfInt32(value){
  if (value < INT_32_MIN_VALUE) {
    return true
  }
  if (value > INT_32_MAX_VALUE) {
    return true
  }
}
